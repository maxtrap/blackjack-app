...
class PlayingHandTests {
    ...
    @Test
    fun testSum() {
        var hand = PlayableHand(ShuffledDeck(), BlackjackGame(), 100, PlayingCard(SPADES, RANK_K), PlayingCard(SPADES, RANK_8), PlayingCard(SPADES, RANK_A), PlayingCard(SPADES, RANK_A))
        assertEquals(20, hand.hand.sum)

        hand = PlayableHand(ShuffledDeck(), BlackjackGame(), 100, PlayingCard(SPADES, RANK_K), PlayingCard(SPADES, RANK_A), PlayingCard(SPADES, RANK_A))
        assertEquals(12, hand.hand.sum)

        hand = PlayableHand(ShuffledDeck(), BlackjackGame(), 100, PlayingCard(SPADES, RANK_7), PlayingCard(SPADES, RANK_A), PlayingCard(SPADES, RANK_A))
    ...
    fun testHit() {
        ...
        val anotherHand = PlayableHand(ShuffledDeck(), BlackjackGame(), 100, PlayingCard(SPADES, RANK_J), PlayingCard(SPADES, RANK_A))
        ...
        val handNumba3 = PlayableHand(ShuffledDeck(), BlackjackGame(), 100, PlayingCard(SPADES, RANK_9), PlayingCard(SPADES, RANK_A))
